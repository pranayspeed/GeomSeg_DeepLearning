...
dataset_dir = "/home/geoseg/Work/git_repo/datasets/Geometry_street/processed_4cls"
...
in_dir = os.path.join(dataset_dir, "programmed")
...
indexs = [int(pcd_file.split(".")[0]) for pcd_file in pcd_files]
#indexs.sort()
