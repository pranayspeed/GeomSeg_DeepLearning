...
from data_multi import data_loaders
from model import RandLANet
from utils.tools import Config as cfg
from utils.metrics import accuracy, intersection_over_union


#python train.py --dataset ~/Work/git_repo/datasets/Geometry_street/processed_new/ --dataset_sampling geomseg

#python train.py --dataset ~/Work/git_repo/datasets/programmed_models/processed/ --dataset_sampling geomseg --batch_size 4 --num_classes 5 --name programmed_BS_4_CLS_5

#python train.py --dataset ~/Work/git_repo/datasets/programmed_models_mixed/processed/ --dataset_sampling geomseg --batch_size 4 --num_classes 5 --name programmed_mixed_BS_4_CLS_5

#python train.py --dataset $NAS_DRIVE/lidar-research/Geometric_Seg_Pranay/datasets/programmed_models/programming_model_1/processed --dataset_sampling geomseg --batch_size 4 --num_classes 5 --name programming_model_1_BS_4_CLS_5



# NOTE: If NAS not mounted first mount using following
# sudo mount -t cifs -o rw,user=<nas_username>,uid=<client_system_username> //10.0.69.42/dl-primary-pool /mnt/share/nas/
# sudo mount -t cifs -o rw,user=pmeshram,uid=pranayspeed //10.0.69.42/dl-primary-pool /mnt/share/nas/
...
def train(args):
    # dataset = Path(os.path.expandvars(args.dataset))
    dataset1 = Path(os.path.expandvars(args.dataset1))
    dataset2 = Path(os.path.expandvars(args.dataset2))
    dataset3 = Path(os.path.expandvars(args.dataset3))
    # train_path = dataset / args.train_dir
    # val_path = dataset / args.val_dir
    train_path1 = dataset1 / args.train_dir
    val_path1 = dataset1 / args.val_dir
    train_path2 = dataset2 / args.train_dir
    val_path2 = dataset2 / args.val_dir
    train_path3 = dataset3 / args.train_dir
    val_path3 = dataset3 / args.val_dir
...
if __name__ == '__main__':
    ...
    # base.add_argument('--dataset', type=Path, help='location of the dataset',
                        # default='/mnt/share/nas/lidar-research/Geometric_Seg_Pranay/datasets/programmed_models/programming_model_1/processed')


    base.add_argument('--dataset1', type=Path, help='location of the dataset 1')
    base.add_argument('--dataset2', type=Path, help='location of the dataset 2')
    base.add_argument('--dataset3', type=Path, help='location of the dataset 3')

    base.add_argument('--num_classes', type=int, help='num_classes',
                        default=5)
    ...
    param.add_argument('--dataset_sampling', type=str, help='how dataset is sampled',
                        default='active_learning', choices=['active_learning', 'naive', 'geomseg'])
