...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/ssd/jiaxin/USIP/USIP_datasets/oxford', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--keypoint_on_pc_alpha', type=float, default=1, help='weight of keypoint_on_pc loss, default 0.5.')
