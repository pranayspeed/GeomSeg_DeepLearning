...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='kitti', help='kitti')
        self.parser.add_argument('--dataroot', default='/ssd/USIP_datasets/kitti', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--node_num', type=int, default=256, help='som node number')
